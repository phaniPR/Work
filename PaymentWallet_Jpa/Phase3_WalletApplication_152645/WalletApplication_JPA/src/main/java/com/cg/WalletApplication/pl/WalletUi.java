			...
			do {
				...
				case 1:
					try {
						...
						iWalletService.validateName(name);
						customer.setName(name);
						System.out.println("Enter Mobile Number");
						String mobileNumber = scanner.next();
						iWalletService.validateMobile(mobileNumber);
				...
				case 2:
					...
					try {
						...
						iWalletService.validateMobile(mobileNum);
						Customer customer = iWalletService.showBalance(mobileNum);
						if (customer != null) {
				...
				case 3:
					try {
						...
						String mobileNum = scanner.next();
						iWalletService.validateMobile(mobileNum);
						Customer customer = iWalletService.check(mobileNum);
						if (customer != null) {
							System.out.println("Enter amount to deposit ");
							BigDecimal amount = scanner.nextBigDecimal();
				...
				case 5:
					try {
						...
						iWalletService.validateMobile(receiverMobile);
						...
						if (result) {
							...
							iWalletService.validateMobile(senderMobile);
							Customer customer = iWalletService.check(senderMobile);
							if (customer != null) {
